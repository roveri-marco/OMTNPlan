(define (domain security-clearance)
	...
	(:action increase_priority_d9
		...
		:effect (and (increase (priority_d9) (factor)) (increase (cost_d9) (* (priority_d9) (factor)) ))
	)
	...
	(:action increase_priority_d10
		...
		:effect (and (increase (priority_d10) (factor)) (increase (cost_d10) (* (priority_d10) (factor)) ))
	)
